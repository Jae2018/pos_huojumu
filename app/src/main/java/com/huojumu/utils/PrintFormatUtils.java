...
public class PrintFormatUtils {
    ...
    // 对齐方式
    private static final int ALIGN_LEFT = 0;   // 靠左
    private static final int ALIGN_CENTER = 1;  // 居中
    private static final int ALIGN_RIGHT = 2;  // 靠右

    //字体大小
    private static final int FONT_NORMAL = 0;  // 正常
    private static final int FONT_MIDDLE = 1;  // 中等
    private static final int FONT_BIG = 2;    // 大

    //加粗模式
    private static final int FONT_BOLD = 0;       // 字体加粗
    private static final int FONT_BOLD_CANCEL = 1;    // 取消加粗
